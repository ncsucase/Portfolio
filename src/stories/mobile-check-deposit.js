export const meta = {
  ...
  duration: '2 years',
  status: 'complete',
  tags: ['Product Design', 'Legal Constraint', 'User Research', 'Mobile'],
  role: 'SVP Interim Authenticated Design Lead',
...
export const content = [
  ...
  },
  {
    ...
    yLabel: 'Negative VOC %',
    yFormat: v => `${v}%`,
    caption: 'MCD as a share of total negative VOC comments, Jan 2023–May 2026.',
    data: [
      { date: '2023-01', value: 4.2 },
      { date: '2023-02', value: 5.8 },
      { date: '2023-03', value: 6.4 },
      { date: '2023-04', value: 5.9 },
      { date: '2023-05', value: 5.3 },
      { date: '2023-06', value: 4.9 },
      { date: '2023-07', value: 4.7 },
      { date: '2023-08', value: 4.5 },
      { date: '2023-09', value: 4.4 },
      { date: '2023-10', value: 4.3 },
      { date: '2023-11', value: 4.4 },
      ...
      { date: '2024-08', value: 3.4 },
      { date: '2024-09', value: 3.2 },
      { date: '2024-10', value: 2.8 },
      { date: '2024-11', value: 2.5 },
      { date: '2024-12', value: 2.4 },
      { date: '2025-01', value: 2.3 },
      { date: '2025-02', value: 2.2 },
      { date: '2025-03', value: 2.1 },
      { date: '2025-04', value: 2.0 },
      { date: '2025-05', value: 2.1 },
      { date: '2025-06', value: 2.3 },
      { date: '2025-07', value: 3.1 },
      { date: '2025-08', value: 3.4 },
      { date: '2025-09', value: 3.2 },
      { date: '2025-10', value: 3.0 },
      { date: '2025-11', value: 2.7 },
      { date: '2025-12', value: 2.5 },
      { date: '2026-01', value: 2.4 },
      { date: '2026-02', value: 2.3 },
      { date: '2026-03', value: 2.2 },
      { date: '2026-04', value: 2.1 },
      { date: '2026-05', value: 2.0 },
    ],
    events: [
      { date: '2023-02', label: 'Features removed', sentiment: 'negative' },
      { date: '2023-03', label: 'VOC peak', sentiment: 'negative' },
      { date: '2023-07', label: 'Users adapt', sentiment: 'neutral' },
      { date: '2024-06', label: 'Court rules vs. USAA', sentiment: 'positive' },
      { date: '2024-09', label: '2024 release ships', sentiment: 'positive' },
      { date: '2025-04', label: 'Design low', sentiment: 'positive' },
      { date: '2025-07', label: 'Tech regression', sentiment: 'negative' },
      { date: '2026-05', label: 'Stabilizing', sentiment: 'neutral' },
    ],
  },
  {
    type: 'paragraph',
