...
export const content = [
  ...
  {
    type: 'paragraph',
    text: `When my scope expanded in 2023 to include all of Truist's authenticated digital banking organization, I inherited a 40+ person team structured around Product Manager alignment. Each designer reported to a design leader who was paired with a Group Product Manager, and individual contributors were assigned to follow their PM's feature area as it evolved.`,
  },
  {
    type: 'paragraph',
  ...
  },
  {
    ...
    columns: [
      ...
      [{
        type: 'inline-svg',
        name: 'mismatchedCoachingFlowchart',
  ...
  {
    type: 'inline-svg',
    name: 'directMgmtOrgModel',
    mobileVariant: 'directMgmtOrgModelMobile',
    title: 'Before',
    subtitle: 'Simple on paper, weak in practice.',
    alt: 'Org model where Design Leader manages all designers in a feature area.',
  },
  {
    type: 'inline-svg',
    name: 'matrixedOrgModel',
    mobileVariant: 'matrixedOrgModelMobile',
    title: 'After',
    subtitle: 'Complex on paper, strong in practice.',
    alt: 'Org model where Design Leader manages only designers of the same discipline.',
  },
  {
    type: 'heading',
    level: 2,
  ...
  {
    type: 'paragraph',
    text: `The design leaders pushed back. Some felt the new structure would reduce their authority over their feature area: if their direct reports were spread across GPM partnerships, they'd lose influence over the work.`,
  },
  {
    type: 'paragraph',
    text: `Designers who now had a separate manager and leader were worried about being micromanaged and balancing orders from two authority figures.`
  },
  {
    type: 'paragraph',
    text: `I addressed these concerns directly: feature partnership and craft leadership are different kinds of authority, and the matrix gives leaders more of both by making each role explicit. It took a couple of months for the team to internalize that, but the resistance dissolved gradually as the outcomes became visible.`,
  },
  {
    type: 'paragraph',
  ...
  {
    type: 'paragraph',
    text: `A 40+ person design organization had been structured for managerial convenience. Restructuring it for craft and continuity changed what it could produce.`,
  },
]
